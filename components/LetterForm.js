    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-xl bg-[#060614] border border-white/10 rounded-t-[2.5rem] md:rounded-[3rem] p-6 md:p-10 shadow-2xl relative overflow-hidden max-h-[85vh] overflow-y-auto"
            >
